...
export type SleepIQAccessoryType = 'occupancy' | 'number' | 'flex' | 'privacy' | 'outlet' | 'lightstrip' | 'footwarmer' | 'remove';
...
export type ApiResponseJSON = FamilyStatusResponse | PauseModeResponse | FoundationStatusResponse | OutletStatusResponse | FootWarmingStatusResponse | Record<string, unknown>;
